...
- 当前阶段：S1区域/病变标注监督审计完成；S1a非临床工程、临床确认、Excel/YAML对账和正式独立录入工程已完成；真实录入被硬门锁定，等待书面确认八个医学定义及八个复核参数；S1b几何可靠性将在S1a通过后另行预登记
...
| 临床本体与穷尽性协议 S1a | 工程、确认包、机器门、工作簿/YAML对账和独立录入工程完成；协议仍为草案、待书面确认 | [S1a协议草案](../project/区域病变标注临床本体与补充标注协议草案_2026-08-02.md)、[工程结果](../project/S1a盲法复核工程准备结果_2026-08-02.md)、[确认包](../project/S1a临床确认包准备结果_2026-08-03.md)、[机器门](../project/S1a临床确认机器门结果_2026-08-03.md)、[对账检查点](../project/S1a临床确认工作簿对账检查点_2026-08-03.md)、[录入工程](../project/S1a正式语义复核录入工程准备结果_2026-08-03.md)、[ADR-011](../decisions/ADR-011-临床确认通过机器门后才允许冻结S1a.md)与[ADR-012](../decisions/ADR-012-拆分S1a语义复核与S1b几何可靠性复核.md) | 确认合同SHA `9abab1...d0e7`；最新版本化审计SHA `8de200...62db`；`ready=false`；Draft真实启动在写文件前拒绝 |
...
- [2026-08-03](logs/2026-08-03.md)：建立并验证S1a临床确认、Excel/YAML对账和正式独立录入链；拆分S1a语义与S1b几何，当前硬门拒绝真实写入，继续等待书面确认。
