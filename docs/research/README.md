...
- 当前阶段：S1区域/病变标注监督审计完成；S1a非临床工程、临床确认工作簿、冻结前机器门和Excel/YAML自动对账已完成；空白模板审计通过但不可冻结，等待书面确认八个医学定义及八个复核参数
...
| 临床本体与穷尽性协议 S1a | 工程、确认包、机器门和工作簿/YAML对账完成；协议仍为草案、待书面确认 | [S1a协议草案](../project/区域病变标注临床本体与补充标注协议草案_2026-08-02.md)、[工程结果](../project/S1a盲法复核工程准备结果_2026-08-02.md)、[确认包](../project/S1a临床确认包准备结果_2026-08-03.md)、[机器门](../project/S1a临床确认机器门结果_2026-08-03.md)、[对账检查点](../project/S1a临床确认工作簿对账检查点_2026-08-03.md)与[ADR-011](../decisions/ADR-011-临床确认通过机器门后才允许冻结S1a.md) | 空白确认合同SHA `9abab1...d0e7`；最新审计报告SHA `428f1e...be2d`；`ready=false`，正式录入未开放 |
...
- [2026-08-03](logs/2026-08-03.md)：建立并验证S1a临床确认工作簿、冻结前机器门和Excel/YAML逐项对账；空白合同通过但不可冻结，八项医学定义与八项复核门槛继续等待书面确认。
