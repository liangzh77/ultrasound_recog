...
- 当前阶段：S1区域/病变标注监督审计完成；S1a真实录入/裁决被硬门锁定，等待书面确认八个医学定义及八个复核参数；G0正常/异常图像门控五折已完成但折间稳定性和ECE失败，候选搜索与融合停止；H0只读异质性审计已提出、待负责人确认；S1b几何可靠性将在S1a通过后另行预登记
...
| H0异质性审计预登记 | [H0：G0折间异质性与非医学代理关联审计](../project/H0_G0折间异质性审计预登记_2026-08-03.md) | 只解释G0失稳，不训练新候选；拟检查fold偏移、错误可预测性和代理概率关联；当前待负责人确认 |
...
| H0 G0异质性审计 | Proposed，待确认 | [H0预登记](../project/H0_G0折间异质性审计预登记_2026-08-03.md) | 复用早于G0生成的数值代理缓存；不读取原图/private/Excel/2026，不产生诊断权重 |
