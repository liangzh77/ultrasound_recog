...
- 当前阶段：S1区域/病变标注监督审计完成；S1a机器本体与补充标注协议草案已形成，等待临床确认八个定义/穷尽性问题后冻结
...
| 临床本体与穷尽性协议 S1a | 草案、400图盲法队列、验收器和ROI只读预览器已完成，待临床确认 | [S1a协议草案](../project/区域病变标注临床本体与补充标注协议草案_2026-08-02.md)与[ADR-010](../decisions/ADR-010-拒绝28类平铺互斥监督并先冻结临床标注协议.md) | 本体/队列/验收器/预览器Git `db5112a`/`befc44e`/`bc41719`/`812067d`；门槛仍待确认，正式录入未开放 |
