...
- 当前阶段：S1区域/病变标注监督审计完成；S1a真实录入/裁决被硬门锁定，等待书面确认八个医学定义及八个复核参数；G0正常/异常图像门控资源pilot已通过，下一步顺序运行固定正式五折；S1b几何可靠性将在S1a通过后另行预登记
...
| G0 正常/异常图像门控 | 资源pilot通过，待正式五折 | [G0预登记](../project/G0患者级正常异常图像门控实验预登记_2026-08-03.md)、[工程闭环](../project/G0患者级正常异常门控工程闭环_2026-08-03.md)、[pilot结果](../project/G0资源pilot结果_2026-08-03.md)与[ADR-013](../decisions/ADR-013-以独立正常异常图像门控重开分层融合.md) | pilot 0.1155小时/5 epochs、峰值保留显存1.393GB、outer test未迭代；正式权重和OOF尚无 |
