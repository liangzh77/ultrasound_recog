...
| 临床本体与穷尽性协议 S1a | 草案、400图盲法队列和结果验收器已完成，待临床确认 | [S1a协议草案](../project/区域病变标注临床本体与补充标注协议草案_2026-08-02.md)与[ADR-010](../decisions/ADR-010-拒绝28类平铺互斥监督并先冻结临床标注协议.md) | 本体/队列/验收器Git `db5112a`/`befc44e`/`bc41719`；门槛仍待确认，尚非正式复核集 |
