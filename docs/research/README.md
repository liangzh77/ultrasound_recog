...
- 当前阶段：E2五折关闭（性能通过、注意力门槛失败）；E2-R实现与配置已冻结，准备fold 0资源pilot
...
| E2-R 单次熵正则补救 | 已预注册并实现，待资源pilot | [ADR-005](../decisions/ADR-005-E2性能门槛通过但注意力塌缩后启动单次熵正则补救.md) | 固定系数0.05；配置SHA `9c6bc8b6…`；不搜索第二强度 |
