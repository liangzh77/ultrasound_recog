...
- 当前阶段：E2-R正式五折完成，正在执行pooled OOF、CI和注意力审计
...
| E2-R 单次熵正则补救 | 正式五折完成，待pooled结论 | [ADR-005](../decisions/ADR-005-E2性能门槛通过但注意力塌缩后启动单次熵正则补救.md) | 五折均高于E1；注意力塌缩门槛3折通过、2折失败，正在执行合并审计 |
