...
- 当前阶段：C0～C4 临床输入审计通过并预登记，待运行固定五折
...
| 临床单模态 C0～C4 | 输入审计通过、已预登记 | [C0～C4临床输入决策](../project/C0_C4临床输入决策与实验预登记_2026-08-02.md) | 临床表SHA `1074255b…eaef`；待正式五折 |
...
- [2026-08-02](logs/2026-08-02.md)：E0/E1/E1-S/E2/E2-R五折、代理审计、A1/A2决策、全部失败路线及持续文档验收。
