...
| 临床本体与穷尽性协议 S1a | 草案及400图盲法复核队列已生成，待临床确认 | [S1a协议草案](../project/区域病变标注临床本体与补充标注协议草案_2026-08-02.md)与[ADR-010](../decisions/ADR-010-拒绝28类平铺互斥监督并先冻结临床标注协议.md) | 本体Git `db5112a`、队列生成器Git `befc44e`；草案队列不含诊断/患者/旧答案/路径，尚非正式复核集 |
