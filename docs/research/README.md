...
- 当前阶段：检查点A1；E1-S ROI几何敏感性消融fold 0～2/5正式完成
...
| 检查点A1 输入选择 | 进行中 | ADR-004与实施计划 | E1-S pilot和正式fold 0～2/5已完成 |
| E2 Attention MIL | 未开始 | 待检查点A1关闭 | 无 |
...
| [ADR-004](../decisions/ADR-004-排除整图主模型并开展ROI几何敏感性消融.md) | Proposed | 排除整图主模型，完成E1-S后冻结ROI几何策略 |
...
- [2026-08-02](logs/2026-08-02.md)：E0/E1正式五折汇总、非医学代理审计、两次性能原因停止、ADR-004、E1-S实现与资源试运行。
