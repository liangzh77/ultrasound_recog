...
- 当前阶段：S1区域/病变标注监督审计完成；S1a真实录入/裁决被硬门锁定，等待书面确认八个医学定义及八个复核参数；G0正常/异常图像门控工程闭环已完成，尚未训练，下一步为fold 0资源pilot；S1b几何可靠性将在S1a通过后另行预登记
...
| G0工程闭环 | [G0患者级正常/异常门控工程闭环](../project/G0患者级正常异常门控工程闭环_2026-08-03.md) | 标签、训练、校准、OOF、注意力、MLflow/哈希和资源门已闭合；下一步仅运行fold 0资源pilot |
...
| G0 正常/异常图像门控 | 工程闭环完成，待资源pilot | [G0预登记](../project/G0患者级正常异常图像门控实验预登记_2026-08-03.md)、[工程闭环](../project/G0患者级正常异常门控工程闭环_2026-08-03.md)与[ADR-013](../decisions/ADR-013-以独立正常异常图像门控重开分层融合.md) | 配置SHA `4a06e6...ed72`；实现Git `59b67d0`；当前无权重、OOF或MLflow run |
