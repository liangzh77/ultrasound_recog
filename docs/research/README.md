...
- 当前阶段：S1区域/病变标注监督审计完成；S1a机器本体、400图盲法队列、结果验收器、ROI只读预览器和全量加载审计已完成，等待临床确认八个定义/穷尽性问题后冻结
...
| 临床本体与穷尽性协议 S1a | 非临床工程准备完成，协议仍为草案、待临床确认 | [S1a协议草案](../project/区域病变标注临床本体与补充标注协议草案_2026-08-02.md)、[工程检查点结果](../project/S1a盲法复核工程准备结果_2026-08-02.md)与[ADR-010](../decisions/ADR-010-拒绝28类平铺互斥监督并先冻结临床标注协议.md) | 本体/队列/验收器/预览器/全量审计Git `db5112a`/`befc44e`/`bc41719`/`812067d`/`3130d6d`；400/400 ROI可加载；正式录入未开放 |
