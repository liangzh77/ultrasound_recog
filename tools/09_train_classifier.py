...
用法:
    python tools/09_train_classifier.py
    python tools/09_train_classifier.py --evaluate
    python tools/09_train_classifier.py --epochs 100 --patience 20
"""
...
from src.common_paths import CLEANED_DIR, LEGACY_CLASSIFIER_DIR, SPLITS_DIR
from src.label_mapping import DISEASE_CLASSES, DISEASE_CLASS_TO_ID

SAVE_DIR = LEGACY_CLASSIFIER_DIR
