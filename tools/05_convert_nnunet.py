...
输出: workspace/data/shared_derived/nnunet/Dataset001_Knee/{imagesTr,labelsTr,imagesTs,labelsTs}/

用法:
    python tools/05_convert_nnunet.py
"""
...
from src.common_paths import CATEGORY_MAPPING_FILE, CLEANED_DIR, NNUNET_DIR as NNUNET_ROOT_DIR, SPLITS_DIR
from src.data_utils import load_category_mapping, load_isat_json, load_split_file

NNUNET_DIR = NNUNET_ROOT_DIR / "Dataset001_Knee"
