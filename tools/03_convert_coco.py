...
输出: workspace/data/shared_derived/coco/{train,val,test}/annotations.json + images/

用法:
    python tools/03_convert_coco.py
"""
...
from src.common_paths import CATEGORY_MAPPING_FILE, CLEANED_DIR, COCO_DIR, SPLITS_DIR
