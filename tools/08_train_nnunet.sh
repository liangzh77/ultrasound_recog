...
#
# 用法:
#   bash tools/08_train_nnunet.sh [preprocess|train|find_best|predict]
#
# 默认执行全部步骤。
...
# 设置 nnU-Net 环境变量
export nnUNet_raw="$ROOT_DIR/workspace/data/shared_derived/nnunet"
export nnUNet_preprocessed="$ROOT_DIR/workspace/data/shared_derived/nnunet_preprocessed"
export nnUNet_results="$ROOT_DIR/workspace/experiments/archive/exp_2026-04_fullimage_legacy_baseline/artifacts/nnunet"
