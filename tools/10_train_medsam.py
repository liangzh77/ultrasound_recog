...
用法:
    python tools/10_train_medsam.py --weights path/to/medsam_vit_b.pth
    python tools/10_train_medsam.py --evaluate --weights path/to/medsam_vit_b.pth
"""
